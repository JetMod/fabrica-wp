...
const PRICE_HINT_LABEL = 'Цена может измениться. Уточняйте при заказе.';
const PRICE_HINT_HTML =
    '<span class="product-card__price-hint" tabindex="0" role="img" aria-label="' + PRICE_HINT_LABEL + '" onclick="event.preventDefault(); event.stopPropagation();">' +
        '<svg class="product-card__price-hint-icon" width="16" height="16" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
        ...
        '</svg>' +
        '<span class="product-card__price-hint-tooltip" role="tooltip">' + PRICE_HINT_LABEL + '</span>' +
    '</span>';
