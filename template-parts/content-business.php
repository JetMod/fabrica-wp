...
$faq_default = array(
    ...
    array('question' => 'Работаете ли по ЭДО?', 'answer' => '<p>Да. Для обмена документами в электронном виде отправьте приглашение на наш ИНН — реквизиты указаны в <a href="' . esc_url(fabrica_get_legal_requisites_url() ?: fabrica_get_legal_base_url()) . '">разделе юридической информации</a>.</p>'),
